...
Use the [implementation session plan](implementation-session-plan.md) to turn
these stories into bounded development-agent prompts. It maps Phases 1–5 to nine
recommended sessions and defines the stopping point for each.
