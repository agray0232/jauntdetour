...
2. **[Implementation Session Plan](ux/implementation-session-plan.md)** —
   agent-ready scope, validation, and stopping points for each development
   session.
3. **[Migration Backlog](ux/migration-backlog.md)** — phased strangler backlog
   from shell and tokens through legacy retirement.
4. **[Concept Directions](ux/concept-directions.md)** — selected map-first
   workspace, Home, My Jaunts, Jaunt Detail, and Account structure.
5. **[Responsive Strategy](ux/responsive-strategy.md)** — layout modes,
   validated viewport matrix, and production checks.
6. **[Current-State Audit](ux/current-state-audit.md)** — existing behavior,
   strengths, and ranked UX/accessibility findings.
7. **[Planning Journey](ux/planning-journey.md)** — JTBD, journey stages, and
   evidence-tagged assumptions.
8. **[Brand and UI Foundations](design-system/foundations.md)** — human-readable
   color, typography, spacing, map, and component guidance.
9. **[Fluent 2 Mapping](design-system/fluent-token-mapping.md)** — production
   theme and component translation.
10. **[Canonical Tokens](../design-system/tokens/jauntdetour.tokens.json)** —
    machine-readable visual source of truth.
11. **[Living Specimen](../design-system/specimen/index.html)** — rendered
    foundations and component examples.
12. **[Clickable Prototype](../spikes/ux-redesign-prototype/README.md)** —
    disposable interaction and composition reference.
13. **[Brand Assets](../design-system/assets/brand/README.md)** — selected SVG,
